  ...
  return (
    <div className="mt-2">
      <div className="grid grid-cols-5 gap-x-4">
        <div className="w-full p-8 flex justify-center rounded-md flex-col items-center gap-y-2 bg-white text-slate-700">
      ...
      <div className="bg-white p-4 mt-5">
        ...
        <div className="realtive overflow-x-auto p-4">
          <table className="w-full text-sm text-left text-slate-600">
            ...
            <tbody>
              {
                [1,2,3,4,5,6,7,8].map((n,i)=> <tr key={i} className="bg-white border-b" >
